...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(3),
		ListContainer = __webpack_require__(1),
		AddList = __webpack_require__(2);
	...
	var App = React.createClass({displayName: "App",
		...
		render: function() {
			var componentList = this.state.lists.map(function(item, index) {
				console.log(item)
				return (
					React.createElement(ListContainer, {title: item.newTitle, key: item.index, remove: this.handleRemoveList, index: index})
				)
			}.bind(this))
			return (
	...
	var AddItem = React.createClass({displayName: "AddItem",
		...
		render: function(){
			return (
				...
				"Add Item: ", React.createElement("input", {type: "text", className: "form-control", placeholder: "New Item", value: this.state.newItem, onChange: this.handleChange, onKeyDown: this.handleSubmit})
				)
			)
		}
	})
	...
	var List = React.createClass({displayName: "List",
		render: function() {
			...
			var listItems = this.props.items.map(function(item, index){
				return (
					React.createElement("li", {className: "list-group-item", style: styles.listGroup}, 
